...
num_char_generated = 300

#text = open('data/pombo.txt').read()
#text = open('data/miocid.txt').read()
text = open('data/quijote.txt').read()
...
#model = load_model('output/v0.1/model.hdf5')
#model = load_model('output/v0.2/model.hdf5')
model = load_model('output/v0.3/model.hdf5')
